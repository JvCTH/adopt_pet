...
public class FragmentPerro extends Fragment implements receiveId {
    ...
    @NonNull
    public static FragmentPerro newInstance() {
        return new FragmentPerro();
    }
    ...
    void init(@NonNull View view) {
        ...
        messageShow.init();
        mRecyclerView = view.findViewById(R.id.recycler_perro);
